...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for the school league",
    ...
    "Music Band": {
        "description": "Learn instruments and perform at school events",
...
def remove_participant(activity_name: str, email: str):
    ...
    activity = activities[activity_name]
    # Ensure participant is currently signed up
